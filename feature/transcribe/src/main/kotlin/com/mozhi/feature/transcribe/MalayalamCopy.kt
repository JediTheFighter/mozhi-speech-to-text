...
object MalayalamCopy {
    ...
    const val Decoding = "Gemini-ലേക്ക് അയയ്ക്കുന്നു…"
    const val PlaceholderIdle = "മലയാളത്തിൽ സംസാരിക്കൂ. നിർത്തിയ ശേഷം എഴുത്ത് ഇവിടെ വരും."
    const val PlaceholderListening = "കേൾക്കുന്നു — നിർത്തിയാൽ Gemini തിരിച്ചറിയും."
    const val HintListening = "കേൾക്കുന്നു — മലയാളത്തിൽ സംസാരിക്കൂ, ശേഷം നിർത്തുക"
    const val HintNoModel = "local.properties-ൽ GEMINI_API_KEY ഇട്ട് ആപ്പ് വീണ്ടും ബിൽഡ് ചെയ്യുക"
